        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                        {{-- <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg={{asset('assets/img/product/jersey5.jpeg')}}>
                        <ul class="product__item__pic__hover">
                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                    ...
                    <div class="product__item__text">
                        <h6><a href="./shop-details.html">Jersey Kuning Set</a></h6>
                        <h5>Rp. 200.000</h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="#">Jersey Hijau Set</a></h6>
                        <h5>Rp. 200.000</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="#">Jersey BluePink Set</a></h6>
                        <h5>Rp. 210.000</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{route ('checkout') }}">Jersey Shirt</a></h6>
                        <h5>Rp. 105.000</h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        <h6><a href="{{route ('checkout') }}">Celana Jersey</a></h6>
                        <h5>Rp. 100.000</h5>
                    </div>
                </div>
            </div>
